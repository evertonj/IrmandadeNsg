...
using IrmandadeNsg.Infra.CrossCutting.Identity.Models.AccountViewModels;
using MediatR;
...
namespace IrmandadeNsg.Services.Api.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                // User claim for write posts data
                await _userManager.AddClaimAsync(user, new Claim("Posts", "Write"));
